...
" Default GUI Colours
let s:foreground = "5a5d5f"
let s:foregroundLight = "9a9daf"
let s:background = "f2f4f5"
let s:selection = "e0e0f6"
let s:line = "ececec"
let s:comment = "aeb0bc"
let s:red = "a82869"
let s:redLight = "d878a9"
let s:orange = "f5871f"
let s:yellow = "fae790"
let s:green = "54a01a"
let s:aqua = "3e999f"
let s:aquaLight = "7eb9bf"
let s:blue = "4271ae"
let s:blueLight = "7291ce"
let s:purple = "8f5fae"
let s:window = "d6d6d6"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=bold cterm=NONE ctermfg=DarkGray ctermbg=NONE gui=NONE guifg=DarkGray guibg=NONE
    ...
    call <SID>X("clojureDefine", s:blue, "", "none")
    call <SID>X("clojureMacro", s:blue, "", "none")
    call <SID>X("clojureKeyword", s:purple, "", "none")
    call <SID>X("clojureBracket", s:foregroundLight, "", "none")
    call <SID>X("clojureParen", s:blue, "", "none")
    call <SID>X("clojureNumber", s:red, "", "none")
    call <SID>X("clojureConstant", s:red, "", "none")
    call <SID>X("clojureBoolean", s:red, "", "none")
